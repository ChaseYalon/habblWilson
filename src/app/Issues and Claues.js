...
var abbortion=new Issue('Abortion',createDistFromFunction(x => x ** 2),[totalBan,forTheLifeOfTheMother,forRapeAndIncest,sixWeekBan,twelveWeekBan,eighteenWeekBan,twenteyWeekBan,twentyTwoWeekBan,twentySixWeekBan,untillFetalVibilaty],false)
    ...
    var sixWeekBan=new Clause('6 week ban',-0.87,'It is hereby adoped that any abbortions unless specificaly later exempted are band 6 weeks after fertilization',[totalBan,twelveWeekBan,sixteenWeekBan,eighteenWeekBan,twenteyWeekBan,twentyTwoWeekBan,twentySixWeekBan,untillFetalVibilaty],0)
